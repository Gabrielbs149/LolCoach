...
/**
  ...
  const app = {
    ...
    skinsEstado: () => skins.estado(), skinsInstalar: () => skins.instalar(), skinsImportar: (o) => skins.importar(o), skinsRemover: (o) => skins.remover(o), skinsEscolher: (o) => skins.escolher(o), skinsTestar: (o) => skins.aplicar(o.campeao), skinsParar: () => skins.parar(), skinsImportarPastas: (o) => skins.importarPastas(o),
